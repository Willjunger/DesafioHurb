...
import jsonListIcon from './icon-list.json';
import { verifyTemperature, toFahrenheit, toCelsius, loadPosition } from './utils';
...
function App() {
	...
	useEffect(() => {
		// CODIGO PARA PEGAR IMAGEM DE FUNDO | AQUI SÓ PRECISO CHAMAR UMA VEZ
	...
	return (
		<div className="App" style={{ backgroundImage: `url(${backgroundImage})` }}>
			<div className="container">
				...
				{error ? (<section className={`error background-none`}><h1>A cidade {textInput} não existe!</h1></section>) : <>
